Contributing to GoldMetalCoin Core
==================================

The GoldMetalCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GoldMetalCoin Core project, and is not to be
confused with overall GoldMetalCoin Network Protocol consensus changes.

Whether a pull request is merged into GoldMetalCoin Core rests with the project merge
...
Patches that change GoldMetalCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the GoldMetalCoin consensus, it must have been
...
The project leader is the release manager for each GoldMetalCoin Core release.
