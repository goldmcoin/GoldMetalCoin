...
#if defined(NDEBUG)
#error "GoldMetalCoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ugmc) are considered zero fee (for relaying and mining)
...
{
    RenameThread("goldmetalcoin-scriptch");
