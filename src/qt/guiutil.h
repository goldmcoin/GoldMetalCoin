...
/** Utility functions used by the GoldMetalCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render GMC addresses in monospace font
...
// Parse "goldmetalcoin:" URI into recipient object, return true on successful parsing
