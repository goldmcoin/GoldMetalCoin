                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    // It doesn't make sense to show the checkbox for sending GMC because you wouldn't check it anyway.
    if (context == Context::Send_GMC)
            ...
            if (newpass1 == newpass2) {
                if (model->setWalletEncrypted(true, newpass1)) {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("GoldMetalCoin will close now to finish the encryption process. "
                               "Remember that encrypting your wallet cannot fully protect "
                               "your GMCs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
