...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("GoldMetalCoin Core"),
     ...
     * override -datadir in the goldmetalcoin.conf file in the default data directory
     * (to be consistent with goldmetalcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
