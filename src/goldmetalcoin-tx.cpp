...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GoldMetalCoin Core goldmetalcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  goldmetalcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded goldmetalcoin transaction") + "\n" +
                               "  goldmetalcoin-tx [options] -create [commands]   " + _("Create hex-encoded goldmetalcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded goldmetalcoin transaction
