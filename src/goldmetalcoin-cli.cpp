...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("GoldMetalCoin Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  goldmetalcoin-cli [options] <command> [params]  " + _("Send command to GoldMetalCoin Core") + "\n" +
                        "  goldmetalcoin-cli [options] help                " + _("List commands") + "\n" +
                        "  goldmetalcoin-cli [options] help <command>      " + _("Get help for a command") + "\n";
