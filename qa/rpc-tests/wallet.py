...
#   c) node1 mines 32 blocks, so now node 0 has 500000GMC, node 1 has 4250GMC, node2 has none.
#   d) node0 sends 601 GMC to node2, in two transactions (301 GMC, then 300 GMC).
