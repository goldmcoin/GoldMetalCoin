...
Intro
-----
GoldMetalCoin (GMC) is a sustainable cryptocurrency modeled after
...
high-powered mining hardware. GoldMetalCoin utilizes an energy efficient proof-of-stake algorithm,
...
Setup
-----
Unpack the files into a directory and run goldmetalcoin-qt.exe.

GoldMetalCoin Core is the original GoldMetalCoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of GoldMetalCoin transactions;
