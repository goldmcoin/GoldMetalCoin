...
GoldMetalCoin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<goldmetalcoin_address\> \<monthly_payment_goldmetalcoin\> [use_ix(true|false)]
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<goldmetalcoin_address\> \<monthly_payment_goldmetalcoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` GMC.
