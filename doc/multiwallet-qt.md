...
In order to support loading of multiple wallets in goldmetalcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is goldmetalcoin.cpp.
...
Changes to goldmetalcoin.cpp
----------------------
goldmetalcoin.cpp is the entry point into goldmetalcoin-qt, and as such, will require some minor modifications to provide hooks for
